...
import laundryTemplate from '@/templates/laundry-ug-1.json';
import itTemplate from '@/templates/it-ug-1.json';
...
import tutoringTemplate from '@/templates/tutoring-ug-1.json';
...
export const TEMPLATES_MAP: Record<string, Template> = {
  ...
  laundry: laundryTemplate as Template,
  it: itTemplate as Template,
  ...
  tutoring: tutoringTemplate as Template,
